              ...
              {gridKeys.map((key) => (
                <ResultsItem key={key}>
                  ...
                  {calculatedEmission !== undefined &&
                    typeof calculatedEmission[key as keyof typeof calculatedEmission] === 'number' && (
                      <ResultsItemValue>
                        {Math.floor((calculatedEmission[key as keyof typeof calculatedEmission] as number) || 0)}
                      </ResultsItemValue>
                    )}
