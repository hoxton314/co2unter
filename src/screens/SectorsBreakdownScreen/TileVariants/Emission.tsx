...
export const Emission: FC<EmissionProps> = observer(({ sectorData, sectorName }) => {
  const store = useContext(StoreContext)
  const { emission } = store.TranslationsState.translations.SectorBreakdown
  return (
    <>
      {sectorName}
      <svg xmlns="http://www.w3.org/2000/svg" height="120px" viewBox="0 -960 960 960" width="120px" fill="#4b4b4b">
      ...
      {`${emission} ${sectorData.totalEmissions}`}
    </>
  )
})
